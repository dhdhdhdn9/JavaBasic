...
//        문자: 혜교, 문자: 87 => 파일로 저장 => 문자: 혜교, 문자: 87
...
//        trycatch를 빼고 예외 메서드 처리함
        String nums = br.readLine();
        System.out.println(nums);

        String num[] = nums.split(" ");
//        regex(구분자)로 입력값을 2개의 문자로 분리하고
        int sum = Integer.parseInt(num[0]) + Integer.parseInt(num[1]);
//        문자가 된 것을 형변환(Integer.parseInt)을 통해 숫자로 바꾼 후 합산
...
//        예외를 시그니처에 추가한 후, 괄호 안에 원하는 형태로 형(태)변환
