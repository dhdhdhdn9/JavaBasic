...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		// 배열
		// 같은 종류의 여러 데이터를 저장하는 자료형
		// 각 배열을 구성하는 각 값들을 요소라고 하고,
		// 배열 시 몇개의 요소를 저장할 지 갯수를 미리 지정해야함.
		...
		// 회원정보(userid, pwd, age)를 저장하는 배열 생성
		String[] uid;
		String[] pwd;
		int[] age;
		...
		uid = new String[3];
				...
				// 참조 자료형 객체는 변수에 그 값에서 대한 위치값이 저장돰
				// 따라서, 실제값을 알아내려면 위치값+변위를 알아야함.
		...
		// 1~45 사이 임의의 숫자 6개를 출력하는 프로그램 작성
		// 임의의 숫자를 생성 : 난수random
		// Random 클래스를 이용하면 원하는 형태의 난수를 생성가능
		int[] lotto = new int[6];
