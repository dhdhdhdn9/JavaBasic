...
public class SayHello {
    //다국어(한국, 일어, 영어)로 인사하는 프로그램 작성
    public static void main(String[] args) {
        // 다국어 인삿말하기 - 국가별 인삿말을 개볇적으로 작성

        SayHelloKr say1 = new SayHelloKr();
        say1.sayHello();
        ...
        //다형성을 이용해서 인삿말을 세련되게 하기
         SayHelloService say = new SayHelloKr();
         say.sayHello();
...
class SayHelloKr implements SayHelloService {
    @Override
