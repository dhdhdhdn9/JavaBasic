...
public class People {
    public static void main(String[] args) {
        // 객체지향 프로그램 개요
        // 모든 데이터를 객체로 취급하여 스프트웨어를 개발함
        // 객체 : 실생활에서 우리가 인식하는 유/무형의 사물

        // 클래스: 객체를 만들어내는 틀, 설계도
        // 클래스에는 객체의 상태를 나타내는 필드/속성과
        // 각자의 기능을 나타내는 메서드로 구성

        // 클래스는 객체의 설계도이기 때문에 실제 정보를 저장할 수 없음
        // 실제 전보를 저장하려면 객체화가 필요함
        // 객체화: 객체를 선언하는 과정
        // 인스턴스 변수(객체 변수): 객체화를 통해 나온 결과물
        ...
        // 생성자를 이용해서 클래스 사용하기
        Person p2 = new Person("김미남","교수",47, "남성", "AB");

        Student s2 = new Student("201350050", "송혜교", "서울 영등포구",
                            "1988.9.17", "컴퓨터", "301");
    ...
    // 고객 클래스
    static class Person {
        // 변수 선언(속성)property 필드field 멤버member
        private String name;
        private String job;
        private int age;
    ...
    static class Student {
        ...
        //매개변수를 생성한 학생클래스
        public Student(String hakno, String name, String addr,
