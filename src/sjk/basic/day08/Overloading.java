...
public class Overloading {
    ...
    public static void main(String[] args) {
        ...
        // 메서드의 서명을 다르게 해서
        // 한 클래스에서 같은 이름의 메서드를 2개 이상 선언하는 것


        // 정수 혹은 실수 매개 변수를 2개 또는 3개를
        ...
        System.out.println(o.add(10.0,10.0));   // 매개변수에 .0 붙이는 이유는
                                                     // 호출 시 double 구분을 위함
        System.out.println(" ");    // 괄호 안에 무엇이 들어가느냐에 따라서
        System.out.println(' ');    // println에 부여된 것들이 달라짐 (커서 대서 확인)
...
class NonOver {
    ...
    public double add_double(double a, double b){
        ...
        // 다향성이 적용되지 않으면
        // 생성한 메서드마다 이름을 제각각 정해야하므로
        // 개발자가 일일히 기억해서 아용해야하는 번거로움 초래
